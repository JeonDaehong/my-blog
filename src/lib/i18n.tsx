...
const translations = {
  ko: {
    ...
    latestPosts: "최신 글",
    studyBlog: "공부 블로그",
    studyBlogDesc: "개인 공부와 사이드 프로젝트, 그리고 개발하며 배운 것들을 기록하는 블로그입니다.\n나중에 다시 찾아볼 수 있도록 배운 내용을 정리하고 있습니다.",
    ...
    tryAnotherQuery: "다른 검색어를 시도해 보세요",
    backToList2: "목록으로",
    viewAll: "전체보기",
    featured: "추천 아티클",
  ...
  en: {
    ...
    studyBlogDesc: "A blog where I record personal study, side projects, and what I learn while building things.\nI write down what I learn so I can find it again later.",
    noStudyPosts: "No posts yet",
    searchTitle: "Search",
    searchPrompt: "Type something to search",
    noSearchResults: "No results",
    searchResultCount: "{count} results",
    clearSearch: "Clear search",
    noResultsFor: "No results for ‘{query}’",
    tryAnotherQuery: "Try a different search term",
