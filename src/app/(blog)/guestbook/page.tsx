...
export default function GuestbookPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Form */}
      <form onSubmit={handleSubmit} className="mb-10 p-4 rounded-xl border border-border-color bg-bg-secondary space-y-3">
      ...
      {loading ? (
        ...
        <p className="text-center text-text-tertiary text-sm py-12">{isKo ? "아직 방명록이 비어있어요. 첫 번째로 남겨주세요!" : "No messages yet. Be the first!"}</p>
      ) : (
